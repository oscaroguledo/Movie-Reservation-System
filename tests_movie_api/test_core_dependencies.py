...
def test_get_genre_service_builds_a_genre_service():
    ...
    service = get_genre_service(producer=producer)
...
def test_get_movie_service_builds_a_movie_service_with_a_genre_service():
    producer = AsyncMock()
    genre_service = get_genre_service(producer=producer)

    service = get_movie_service(producer=producer, genre_service=genre_service)
...
def test_get_showroom_service_builds_a_showroom_service():
    ...
    service = get_showroom_service(producer=producer)
...
def test_get_screening_service_builds_a_screening_service_with_its_dependencies():
    producer = AsyncMock()
    movie_service = get_movie_service(producer=producer, genre_service=get_genre_service(producer))
    showroom_service = get_showroom_service(producer=producer)

    service = get_screening_service(
        producer=producer, movie_service=movie_service, showroom_service=showroom_service
    )
...
def test_get_reservation_service_builds_a_reservation_service_with_a_screening_service():
    ...
    service = get_reservation_service(producer=producer, screening_service=screening_service)
